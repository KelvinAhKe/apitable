...
Then open [http://localhost:80](http://localhost:80) in your browser to visit it. (nom d'utilisateur par défaut `admin@apitable.com` et mot de passe `Apitable2022`)
